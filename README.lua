...
Frame.Parent = kenthub
Frame.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
Frame.BorderSizePixel = 0
Frame.Position = UDim2.new(0.416258067, 0, 0.346531957, 0)
Frame.Size = UDim2.new(0, 209, 0, 245)
...
local function ZTJU_fake_script() -- kenthub.KentHubDraggable 
...
coroutine.wrap(ZTJU_fake_script)()
local function FCQLH_fake_script() -- kenthub.KentHubPersist 
	local script = Instance.new('LocalScript', kenthub)
...
coroutine.wrap(FCQLH_fake_script)()
local function XLWNRL_fake_script() -- Frame.KentHubAppearAnimation 
...
coroutine.wrap(XLWNRL_fake_script)()
local function PYQVKK_fake_script() -- Ground.LocalScript 
...
coroutine.wrap(PYQVKK_fake_script)()
local function MILKW_fake_script() -- ImageLabel.LocalScript 
	local script = Instance.new('LocalScript', ImageLabel)

	script.Parent.Image = "http://www.roblox.com/Thumbs/Avatar.ashx?x=100&y=100&userId=" .. game.Players.LocalPlayer.UserId
end
coroutine.wrap(MILKW_fake_script)()
local function KBVQNL_fake_script() -- Name.LocalScript 
	local script = Instance.new('LocalScript', Name)

	script.Parent.Text = game.Players.LocalPlayer.Name
end
coroutine.wrap(KBVQNL_fake_script)()
local function ERHTQ_fake_script() -- Waves.LocalScript 
...
coroutine.wrap(ERHTQ_fake_script)()
local function UVRGVLS_fake_script() -- Floor.LocalScript 
...
coroutine.wrap(UVRGVLS_fake_script)()
local function TNQGTZ_fake_script() -- Tp.LocalScript 
